...
import business.EvaluationFacade;
...
public class EvaluationController implements Serializable {
    ...
    @EJB
    private business.EvaluationFacade ejbFacade;
    ...
    public Evaluation getEvaluation(java.lang.Integer id) {
    ...
    public static class EvaluationControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Evaluation) {
                ...
                return getStringKey(o.getEvaluationId());
            } else {
