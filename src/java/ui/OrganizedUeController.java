...
public class OrganizedUeController implements Serializable {
    ...
    private OrganizedUe current;
    private DataModel items = null;
    @EJB
    private business.OrganizedUeFacade ejbFacade;
    ...
    public OrganizedUe getSelected() {
        if (current == null) {
            current = new OrganizedUe();
            selectedItemIndex = -1;
        }
        return current;
    }

    private OrganizedUeFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (OrganizedUe) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OrganizedUeCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OrganizedUeUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("OrganizedUeDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
